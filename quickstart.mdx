...
<Tabs>
  ...
  <Tab title="As NPM Package">
    Install the published package to use the TypeScript utilities:

    <CodeGroup>
    ```bash npm
    npm install @eco-foundation/routes
    ```

    ```bash yarn
    yarn add @eco-foundation/routes
    ```

    ```bash pnpm
    pnpm add @eco-foundation/routes
    ```
    </CodeGroup>
